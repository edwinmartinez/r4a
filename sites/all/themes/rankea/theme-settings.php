...
/**
 * USAGE:
 * 1 - To use this file replace "rankea" with the name of
...
// Replace 'rankea' with your themes name, eg:
// function your_themes_name_form_system_theme_settings_alter(&$form, &$form_state)
function rankea_form_system_theme_settings_alter(&$form, &$form_state)  {
